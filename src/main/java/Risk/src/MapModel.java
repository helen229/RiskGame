...
//        System.out.println("Continent Name is not exist, please enter another one");
    ...
    public void setValid(boolean valid) {
  	...
  	public boolean adjacency(String sourceCountryName, String destinationCountryName) {
  		ArrayList<CountryModel> countryList= this.getCountryList();
  		CountryModel destinationCountry=countryList.get(this.indexOfCountry(destinationCountryName));
  		
  		boolean isAdjacent;
		if (countryList.get(this.indexOfCountry(sourceCountryName)).getNeighbours()
  				.contains(destinationCountry.getCountryValue())) {
  			isAdjacent = true;
  		} else {
  			isAdjacent = false;
  		}
  	...
  	public ArrayList<Integer> getAdjacencies(String countryName) {
  		return this.getCountryList().get(this.indexOfCountry(sourceCountryName)).getNeighbours();
      }
